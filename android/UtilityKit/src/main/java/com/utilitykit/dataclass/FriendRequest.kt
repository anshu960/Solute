...
class FriendRequest(
    ...
    var data: ContentValues
        get() {
            ...
            dict.put(Key.isAccepted, isAccepted)
    ...
    constructor(info: Any) : this() {
        try {
            ...
            this.isAccepted = obj.getInt(Key.isAccepted)
    ...
    constructor(info: JSONObject) : this() {
        try {
            ...
            this.isAccepted = info.getInt(Key.isAccepted)
    ...
    constructor(info: ContentValues) : this() {
        try {
            ...
            this.isAccepted = info.getAsInteger(Key.isAccepted)
