...
class CreateProductFragment : Fragment() {
    ...
    fun populateExistingProduct(){
        if(ProductHandler.shared().repository.selectedProduct.value != null){
            ...
            productMRPEditText?.setText(product!!.ProductPrice?.MRP!!.toString())
            productCostPriceEditText?.setText(product!!.ProductPrice?.CostPrice!!.toString())
            productPriceEditText?.setText(product!!.ProductPrice?.Price!!.toString())
            productIGSTEditText?.setText(product!!.ProductPrice?.IGST!!.toString())
            productCGSTEditText?.setText(product!!.ProductPrice?.CGST!!.toString())
            productSGSTEditText?.setText(product!!.ProductPrice?.SGST!!.toString())
            productVATEditText?.setText(product!!.ProductPrice?.VAT!!.toString())
            productCESSEditText?.setText(product!!.ProductPrice?.CESS!!.toString())
            productTotalTaxEditText?.setText(getString(R.string.price_string,product!!.ProductPrice?.Tax))
            productDiscountEditText?.setText(getString(R.string.price_string,product!!.ProductPrice?.Discount))
            productFinalPriceEditText?.setText(getString(R.string.price_string,product!!.ProductPrice?.FinalPrice))
            productTaxFinalPriceEditText?.setText(getString(R.string.price_string,product!!.ProductPrice?.FinalPrice))
