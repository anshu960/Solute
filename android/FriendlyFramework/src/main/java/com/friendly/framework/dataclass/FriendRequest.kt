...
class FriendRequest(
    ...
    var data: ContentValues
        get() {
            ...
            dict.put(KeyConstant.isAccepted, isAccepted)
    ...
    constructor(info: Any) : this() {
        try {
            ...
            this.isAccepted = obj.getInt(KeyConstant.isAccepted)
    ...
    constructor(info: JSONObject) : this() {
        try {
            ...
            this.isAccepted = info.getInt(KeyConstant.isAccepted)
    ...
    constructor(info: ContentValues) : this() {
        try {
            ...
            this.isAccepted = info.getAsInteger(KeyConstant.isAccepted)
...
//        }
    ...
    fun downloadFriendFriendRequest() {
        var request = JSONObject()
//        request.put(KeyConstant._id, UtilityKitApp.user._id)
