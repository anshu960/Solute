...
enum class SocketEvent(val value: String)
{
    ...
    updateFriendlyProfile("UPDATE_PROFILE"),
    ...
    REMOVE_STOCK_QUANTITY("REMOVE_STOCK_QUANTITY"),
    RESET_STOCK_QUANTITY("RESET_STOCK_QUANTITY"),
    CREATE_PRODUCT_BAR_CODE("CREATE_PRODUCT_BAR_CODE"),
    UPDATE_PRODUCT_BAR_CODE("UPDATE_PRODUCT_BAR_CODE"),
    RETRIEVE_PRODUCT_BAR_CODE("RETRIEVE_PRODUCT_BAR_CODE"),
    DELETE_PRODUCT_BAR_CODE("DELETE_PRODUCT_BAR_CODE"),
