...
// material
import { DialogActions, DialogContent, DialogContentText, Grid, Stack } from '@mui/material';
import AddCustomerAction from './AddTenantAction';
...
export default function AddTenant({setOpen, setLoading}) {
