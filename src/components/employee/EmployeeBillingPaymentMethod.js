...
export default function AccountBillingPaymentMethod({ employee, isOpen, onOpen, onCancel ,onRefresh,setLoading,toast}) {
  ...
  const retrivePaymentHistory=()=>{
      ...
      console.log("RETRIVE_EMPLOYEE_PAYMENT REQUEST",request);
      console.log("RETRIVE_EMPLOYEE_PAYMENT employee",employee);
      SendEvent(SocketEvent.RETRIVE_EMPLOYEE_PAYMENT,request,handleRetrivePayemntEvent);
  }
  ...
  const handleUpdateInputChange = (event) => {
    ...
    console.log("employeeToEdit",JSON.stringify(payment))
  ...
  const onClickAddPayment=(event)=>{
    ...
    console.log("ADD_EMPLOYEE_PAYMENT REQUEST",request);
    console.log("ADD_EMPLOYEE_PAYMENT payment Edit",payment);
    SendEvent(SocketEvent.ADD_EMPLOYEE_PAYMENT,request,handleUpdatePayemntEvent);
}
