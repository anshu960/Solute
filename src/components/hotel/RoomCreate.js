...
import { RoomImage } from '.';
import CheckboxField from '../CheckboxField';
import Select from 'react-select';
import { AmenitiesFields, productFields, taxFields } from './FieldConfig';
...
export default function RoomCreate({handleAddProduct}) {
