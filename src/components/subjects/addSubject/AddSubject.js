...
import AddSubjectAction from './AddSubjectAction';
...
export default function AddSubject({setOpen, setLoading}) {
  ...
  return (
    <React.Fragment style={{outerHeight:800}}>
      ...
      <DialogActions sx={{justifyContent: 'end'}}>
          <AddSubjectAction handleConfirm={handleConfirm} setOpen={setOpen} />
      </DialogActions>  
    </React.Fragment>
  );
}