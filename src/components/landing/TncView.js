...
const   TnC = (props) => {
    ...
    <div>
        ...
        <p>In any case if the refund processed it may take 5 to 7 working days and would be credit to directly the mode of payment is opted or could be settled any special cases. In some cases refund may take longer which completely depend on the mode of payment opted and associated issues faced by the mode of party facing.Solute is not responsible any refund if two or more different parties are involved in payment directly/indirectly.</p>
        ...
        <p>This agreement can be terminated by any Party by providing 30 days&rsquo; prior written notice to the other Party.&nbsp;</p>
